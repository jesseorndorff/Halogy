				...
				?>
					<li class="fixed">
						<div class="halogycms_thumb">
							<a href="#" class="halogycms_insertimage" title="<?php echo $image['imageRef']; ?>"><?php echo ($thumb = display_image($imageThumbPath, $image['imageName'], 50)) ? $thumb : display_image($imagePath, $image['imageName'], 50); ?></a>
						</div>
