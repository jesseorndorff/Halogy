				...
				<?php foreach ($folder['files'] as $file): ?>
					...
					<li>
						<div class="halogycms_thumb">
							<a href="#" class="halogycms_insertfile" title="<?php echo $file['fileRef']; ?>"><img src="<?php echo $this->config->item('staticPath'); ?>/fileicons/<?php echo $extension; ?>.png" alt="<?php echo $file['fileRef']; ?>" /></a>
						</div>
