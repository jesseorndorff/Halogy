...
<div id="tpl-forum" class="module">
	...
	<div class="headingright">
		{if topic:subscribed}
			<a href="/forums/subscribe/{topic:id}" class="button">Unsubscribe</a>
		{else}
			<a href="/forums/subscribe/{topic:id}" class="button">Subscribe</a>
		{/if}
		{if topic:locked}
			<a href="#" class="button" style="opacity: 0.5;">Locked</a>
		{else}
			<a href="/forums/addreply/{topic:id}" class="button">Post Reply</a>
		{/if}
	</div>
