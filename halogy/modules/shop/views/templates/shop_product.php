		...
		<form method="post" action="/shop/cart/add" class="default">
				...
				<div id="reviews">
					...
					{if product:reviews}
						...
						<div class="review {review:class}" id="review{review:id}">
							...
							<div class="col2">
								<img src="http://static.halogy.com/themes/default/images/rating{review:rating}.gif" alt="{review:rating} Rating" class="rating" />
			...
			<div class="purchase">
				...
				{else}
					...
					<p><img src="http://static.halogy.com/images/noimage.gif" alt="Product image" class="productpic" /></p>
