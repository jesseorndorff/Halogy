...
<div id="tpl-shop" class="module">
	...
	<div class="col col1">
		...
		<div style="float: right;">
			<p><a href="/shop/cart" class="button">Update Order</a></p>
		</div>
		...
		<div style="float: right;">
			<p><a href="/shop/account/checkout" class="button">Update Address</a></p>
		</div>
		<br class="clear" />
		...
		<form action="{shop:gateway}" method="post" class="default">
			...
			<div style="float:right">
				<a href="/shop/cancel" class="button grey">Cancel Order</a>
